module.exports = {
    "name": "Single Current Child Sponsorship RCC"
    ,"description": "Account with single, current RCC child sponsorship."
    ,"records": [{
    ...
    ,{
       ...
       ,"row": {
             "EmailType"    : "HOME"
            ,"EmailAddress" : "singleCRCC@fh.org"
            ,"Active"       : 1
            ,"UseAsPrimary" : 1
            ,"DataSource"   : "FH"
       }
